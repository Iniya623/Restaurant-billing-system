const defaultMenuItems = [
    {
        ...
        price: 30,
        category: 'morning',
        imageUrl:'https://via.placeholder.com/400x300/4CAF50/FFFFFF?text=Idly',
    },
    {
        id: 2,
        name: 'Puttu',
        price: 40,
        category: 'morning',
        imageUrl: 'https://via.placeholder.com/400x300/4CAF50/FFFFFF?text=Puttu'
    },
    {
        id: 3,
        name: 'Poori',
        price: 35,
        category: 'morning',
        imageUrl: 'https://via.placeholder.com/400x300/4CAF50/FFFFFF?text=Poori'
    },
    {
        id: 4,
        name: 'Coffee',
    ...
    },
    {
        ...
        price: 50,
        category: 'lunch',
        imageUrl: 'https://via.placeholder.com/400x300/4CAF50/FFFFFF?text=Dosa'
    },
    {
        id: 6,
        name: 'Vada',
        price: 30,
        category: 'morning',
        imageUrl: 'https://via.placeholder.com/400x300/4CAF50/FFFFFF?text=Vada'
    },
    {
        id: 7,
...
function displayMenu(category = 'all') {
    ...
    filteredItems.forEach(item => {
        ...
        menuItemDiv.innerHTML = `
            <img src="${item.imageUrl}" alt="${item.name}" loading="lazy" onerror="this.onerror=null; this.src='https://via.placeholder.com/400x300/4CAF50/FFFFFF?text=${encodeURIComponent(item.name)}'">
